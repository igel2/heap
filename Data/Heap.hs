...
filter :: (HeapItem pol item) => (item -> Bool)
       -> Heap (Prio pol item) (Val pol item)
       -> Heap (Prio pol item) (Val pol item)
...
--- from the 'Heap'.
take :: (HeapItem pol item) => Int -> Heap (Prio pol item) (Val pol item) -> [item]
take n = fst . splitAt n

--- | Remove the lowest @n@ priority-value pairs, in ascending order of priority,
--- from the 'Heap'.
drop :: (HeapItem pol item) => Int -> Heap (Prio pol item) (Val pol item)
     -> Heap (Prio pol item) (Val pol item)
...
takeWhile :: (HeapItem pol item) => (item -> Bool) -> Heap (Prio pol item) (Val pol item)
          -> [item]
takeWhile p = fst . (span p)

--- | @'dropWhile' p h@ removes the longest prefix of priority-value pairs of @h@
--- in ascending order of priority that satisfy @p@.
dropWhile :: (HeapItem pol item) => (item -> Bool) -> Heap (Prio pol item) (Val pol item)
          -> Heap (Prio pol item) (Val pol item)
...
--- removed.
span :: (HeapItem pol item) => (item -> Bool) -> Heap (Prio pol item) (Val pol item)
     -> ([item], Heap (Prio pol item) (Val pol item))
...
--- elements removed.
break :: (HeapItem pol item) => (item -> Bool) -> Heap (Prio pol item) (Val pol item)
      -> ([item], Heap (Prio pol item) (Val pol item))
break p = span (not . p)
...
{-# SPECIALISE fromFoldable :: (HeapItem pol item) => [item] -> Heap (Prio pol item) (Val pol item) #-}

--- | /O(n)/. Lists all priority-value pairs of the 'Heap' in no specific order.
toList :: (HeapItem pol item) => Heap (Prio pol item) (Val pol item) -> [item]
...
{-# SPECIALISE fromAscFoldable :: (HeapItem pol item) => [item] -> Heap (Prio pol item) (Val pol item) #-}

--- | /O(n)/. Lists priority-value pairs of the 'Heap' in ascending order of
--- priority.
toAscList :: (HeapItem pol item) => Heap (Prio pol item) (Val pol item)
          -> [item]
...
{-# SPECIALISE fromDescFoldable :: (HeapItem pol item) => [item] -> Heap (Prio pol item) (Val pol item) #-}
...
toDescList :: (HeapItem pol item) => Heap (Prio pol item) (Val pol item) -> [item]
